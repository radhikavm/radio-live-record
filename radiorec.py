...
def read_settings(args):
    ...
    if args.settings:
        ...
        settings_base_dir = os.getenv('HOME') + os.sep + 'Documents' + os.sep + \
                            '_WEB' + os.sep + 'radiorec'
...
def record_worker(stoprec, streamurl, target_dir, args):
    ...
    verboseprint(print_time() + " ... Writing to: " + filename + ", Content-Type: " + conn.headers.get('Content-Type'))
